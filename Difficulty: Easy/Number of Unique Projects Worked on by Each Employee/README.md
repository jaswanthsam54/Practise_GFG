...
<p class="" data-start="1720" data-end="1736">The result is a <strong>DataFrame </strong>having&nbsp;<strong data-start="1008" data-end="1023">employee_id</strong> and <strong>cnt</strong> .</p>
...
<blockquote>
<pre><span style="font-size: 14pt;">Note: Please use the same variable names and format as shown in the output</span></pre>
