<h2><a href="https://www.geeksforgeeks.org/problems/element-wise-exponentiation/1?page=3&category=python&sortBy=submissions">Element-wise Exponentiation</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><h3 class="" data-start="107" data-end="131"><span style="font-size: 14pt;">Problem Description:</span></h3>
...
<p class="" data-start="472" data-end="556"><span style="font-size: 14pt;"><strong data-start="472" data-end="488">Explanation:</strong> Each element of the array [1, 2, 3, 4] is raised to the power of 2.</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>python</code>&nbsp;