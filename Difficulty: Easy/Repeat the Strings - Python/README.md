<h2><a href="https://www.geeksforgeeks.org/problems/repeat-the-strings/1?page=1&category=python-conditionals,python-set&difficulty=Easy,Medium,Hard&sortBy=submissions">Repeat the Strings - Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px; color: #000000;"><strong>Whooaah</strong>! Your are now familiar with String slicing. Let's have one more question to make it crystal clear for you with some conditional statements.</span></p>
